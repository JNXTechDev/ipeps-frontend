...
import ScholarshipApplications from '../ScholarshipApplications/ScholarshipApplications';
import ScholarshipSearch from './ScholarshipSearch';

const ScholarshipSearchHeader = ({ isCollapsed, searchQuery, setSearchQuery, handleSearch }) => {
  const inputStyles = {
...
export default ScholarshipSearchHeader;
