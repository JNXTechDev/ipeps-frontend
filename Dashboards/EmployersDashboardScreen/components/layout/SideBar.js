...
const Item = ({ title, to, icon, selected, setSelected, onSettingsClick, showSettings, setShowSettings, isCollapsed }) => {
    ...
    const handleClick = () => {
        ...
        if (title === "Settings") {
            onSettingsClick?.();
            navigate('/dashboard/employer/settings');
            return;
        } else {
...
const SideBar = ({ isCollapsed, setIsCollapsed }) => {
    ...
    useEffect(() => {
        if (location.pathname === '/dashboard/employer/settings') {
                    ...
                    <Menu>
                        ...
                        <Box paddingLeft={isCollapsed ? undefined : "2%"}>  {/* Changed from 10% to 5% */}
                            ...
                            <MenuSection
                                title="POSTINGS"
                                isCollapsed={isCollapsed}
                                isOpen={openSections.postings}
                                onToggle={() => toggleSection('postings')}
                            >
                                  <Item
                                    title="Job Posting"
                                    to="/dashboard/employer/job-posting"
                                ...
                                <Item
                                    ...
                                    to="/dashboard/employer/training-posting"
                                ...
                                <Item
                                    ...
                                    to="/dashboard/employer/scholarship-posting"
                                    icon={<SchoolOutlined />}
                                    selected={selected}
                                    setSelected={setSelected}
                                    showSettings={showSettings}
                            ...
                            >
                                ...
                                <Item
                                    ...
                                    to="/dashboard/employer/manage-employers"  // Simplified path
